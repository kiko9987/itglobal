...
@pytest.mark.parametrize('addr, expected', [
    ...
    # 광주 통합특별시 명칭도 '전남 광주' (경기 광주시와 구분, L-03672)
    ('전남광주통합특별시 남구 제중로 11', '전남 광주 남구 제중로 11'),
    ('광주전남통합특별시 동구 충장로 1', '전남 광주 동구 충장로 1'),
    # 제주 서귀포시 → 서귀포 (pre-existing 갭 보완)
    ('제주 서귀포시 중문동', '서귀포 중문동'),
    ('제주특별자치도 서귀포시 중문로 1', '서귀포 중문로 1'),
])
