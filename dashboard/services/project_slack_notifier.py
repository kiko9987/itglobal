...
def _build_message(data: dict, code: str) -> str:
    ...
    lines = [
        ...
        "---------------------------------------------",
        f":convenience_store: 유입 구분 : {_val(data, '유입 구분')}",
        f":clipboard: 사업자명 : {_val(data, '사업자명')}",
        ...
        f":memo: 공사 내용 : {_val(data, '공사 내용')}",
        f":wrench: 도급 구분 : {_val(data, '도급 구분')}",
        f":construction_worker: 시공자 : {_val(data, '시공자')}",
        f":moneybag: 공사 금액 : {amount_line}",
