...
def normalize_cash_layout(text: str, default_receiver: str = '') -> str:
    ...
    수령자: 문장에서 추출('YG 수령') 우선, 없으면 default_receiver(메시지 올린 사람
    이니셜)로 채움 — 현금 메시지는 YG/JW/SB 셋만 올리고 그 사람=수령자라, 안 적어도
    올린 사람으로 붙는다 (2026-09-02 R4052-TH 계기)."""
