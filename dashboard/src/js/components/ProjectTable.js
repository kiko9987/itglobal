...
function getStageBillIconForTable(status) {
  const iconMap = {
    ...
    '기타': '<i class="fas fa-circle-question fa-lg ms-1 text-warning" title="특이 정산 (메모 참고)"></i>',
    '확인필요': '<i class="fas fa-circle-question fa-lg ms-1 text-warning" title="특이 정산 (메모 참고)"></i>',
    '혼합': '<i class="fas fa-circle-question fa-lg ms-1 text-warning" title="특이 정산 (메모 참고)"></i>'
  };
